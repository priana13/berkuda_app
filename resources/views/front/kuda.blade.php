    ...
    <div class="row">
      ...
      <div class="carousel slide" style="height:150px;">
          ...
          <div class="carousel-item active p-5 ">
              <h5 class="fs-1 text-center text-white text-uppercase" >KUDA</h5> 
          </div>
      </div>
...
{{-- 
  ...
  <div class="row mt-5">
    ...
    <div class="col-md-5 ml-2">
      <div class="row mb-4">
        <h3>{{$product->nama_kuda}}</h4>

        <h6 clsss="h6">Jenis: <strong>{{$product->jenis_kuda}}</strong></h6>
      </div>
      ...
      <form action="{{route('order')}}" class="form-inline" method="post">
          @csrf
          <input type="hidden" name="kuda_id" value="{{$product->id}}">
          <input type="hidden" name="is_kuda" value="true">
          ...
          <div class="form-group">
              <button class="btn btn-lg btn-warning me-md-2 text-white tombo-slider form-control" >PINANG SEKARANG</button>
          </div>
