    ...
    <div class="row">
      ...
      <div class="carousel slide" style="height:150px;">
          ...
          <div class="carousel-item active p-5 ">
              <h5 class="fs-1 text-center text-white text-uppercase" >PILIH KUDA TERBAIK MU</h5> 
          </div>
      </div>
    ...
    <div class="row justify-content-center mt-3">
        ...
        @foreach($kuda as $product)
            ...
            <div class="card-body">
                ...
                <a class="btn btn-lg btn-outline-warning text-warning tombo-slider"  href="{{route('kuda.show',$product->id)}}">PINANG</a>
            </div>
            </div>
