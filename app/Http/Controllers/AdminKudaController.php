<?php namespace App\Http\Controllers;
	...
	class AdminKudaController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "nama_kuda";
			$this->limit = "20";
			...
			$this->col = [];
			$this->col[] = ["label"=>"Nama Kuda","name"=>"nama_kuda"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Nama Kuda','name'=>'nama_kuda','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Nama Kuda","name"=>"nama_kuda","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Umur","name"=>"umur","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Jenis Kuda","name"=>"jenis_kuda","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
