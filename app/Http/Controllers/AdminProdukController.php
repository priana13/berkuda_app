<?php namespace App\Http\Controllers;
	...
	class AdminProdukController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Nama Paket","name"=>"nama_paket","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Qty Pertemuan","name"=>"qty_pertemuan","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
	        ...
	        */
			...
			$this->addaction[] = ['label'=>'Lihat','url'=>url('paket/[id]'),'icon'=>'fa fa-eye','color'=>'warning', 'target' => '_blank'];
